...
s=Service(r'C:\Users\user\PycharmProjects\SITProject\chromedriver.exe') #Local file location for chromedriver.exe to use selenium to use the webbrowser
